...
function Rightbar({ isOpen, toggleRightbar }) {
  return (
    <aside className={`fixed right-0 top-14 bottom-14 w-64 p-6 bg-teal-700 text-white opacity-100 ${isOpen ? styles.bubbleOpen : styles.bubbleClosed} border-l-2 border-green-400 shadow-lg shadow-green-400/20 z-50 ${styles.customRightbar}`}>
