...
function Sidebar({ isOpen, toggleSidebar }) {
  return (
    <div className={`fixed top-0 left-0 bottom-0 w-64 text-white opacity-100 ${isOpen ? styles.bubbleOpen : styles.bubbleClosed} z-50 border-r-2 border-green-400 ${styles.customSidebar}`}>
